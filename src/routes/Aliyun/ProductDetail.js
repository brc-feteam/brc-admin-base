  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        dataIndex: 'operation',
        render: (text, record) => {
          return <Button onClick={e => this.handleSelectDevice(record, e)}>查看</Button>;
        },
      },
    ];
    ...
    const UIDeviceList = () => <Table {...tableProps} rowKey={record => record.iotId} />;
    ...
    return (
      <PageHeaderLayout title="产品设备" content="产品设备信息。">
