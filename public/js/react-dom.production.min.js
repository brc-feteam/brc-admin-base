...
(function(pa, l) {
      ...
      ? a === b
        ...
        : Id(a)
          ...
          : Id(b)
            ...
            : 'contains' in a
              ? a.contains(b)
              : a.compareDocumentPosition ? !!(a.compareDocumentPosition(b) & 16) : !1
      : !1;
  }
  function Jd(a) {
  ...
  function Oa(a, b) {
    ...
    null === c
      ? pb(a, b)
      : null === a.last || null === c.last ? (pb(a, b), pb(c, b)) : (pb(a, b), (c.last = b));
  }
  function Rd(a, b, c, d) {
    a = a.partialState;
    ...
    function p(a, b, c, d) {
      ...
      if ('object' === typeof c && null !== c) {
        switch (c.$$typeof) {
          case sb:
            return c.key === e
              ? c.type === Y ? m(a, b, c.props.children, d, e) : k(a, b, c, d)
              : null;
          case ja:
  ...
  function fe(a, b, c, d, e) {
    ...
    for (var f = 0; f < b.length; f += 2) {
      ...
      'style' === g
        ? Zd(a, h, Ra)
        : 'dangerouslySetInnerHTML' === g ? de(a, h) : 'children' === g ? ub(a, h) : Rb(a, g, h, d);
    }
    switch (c) {
      case 'input':
        Ub(a, e);
  ...
  var xf = {
    ...
    Ff = Ua.extend({
      key: function(a) {
        ...
        return 'keypress' === a.type
          ...
          : 'keydown' === a.type || 'keyup' === a.type ? Ef[a.keyCode] || 'Unidentified' : '';
      },
      location: null,
      ctrlKey: null,
      shiftKey: null,
    ...
    Jf = Va.extend({
      ...
      deltaY: function(a) {
        return 'deltaY' in a
          ? a.deltaY
          : 'wheelDeltaY' in a ? -a.wheelDeltaY : 'wheelDelta' in a ? -a.wheelDelta : 0;
      },
      deltaZ: null,
      deltaMode: null,
    }),
    ...
    Nf = function(a, b, c, d, e) {
      function f(a, b, c, d, e, f) {
        ...
        return 'function' === typeof m.shouldComponentUpdate
          ...
          : a.prototype && a.prototype.isPureReactComponent ? !cc(b, c) || !cc(d, e) : !0;
      }
      function g(a, b) {
        b.updater = v;
        a.stateNode = b;
        ...
        beginWork: function(a, b, c) {
          ...
          switch (b.tag) {
            ...
            case 2:
              e = r(b);
              null === a
                ? null === b.stateNode ? (H(b, b.pendingProps), re(b, c), (d = !0)) : (d = I(b, c))
                : (d = J(a, b, c));
              f = !1;
              var g = b.updateQueue;
      ...
      return {
        ...
        commitPlacement: function(a) {
          ...
          for (var e = a; ; ) {
            if (5 === e.tag || 6 === e.tag)
              c
                ? d ? A(b, e.stateNode, c) : z(b, e.stateNode, c)
                : d ? y(b, e.stateNode) : t(b, e.stateNode);
            else if (4 !== e.tag && null !== e.child) {
              e.child['return'] = e;
              e = e.child;
              continue;
        ...
        a =
          0 !== Ba
            ...
            : ta
              ? T ? 1 : na
              : a.mode & 1
                ? Fa ? 10 * ((((m() + 15) / 10) | 0) + 1) : 25 * ((((m() + 500) / 25) | 0) + 1)
                : 1;
        Fa && (0 === ua || a > ua) && (ua = a);
        return a;
      }
